          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2 bg-[#eff6ff] border border-[#bfdbfe] rounded-lg p-3">
              ...
              <p className="text-xs text-[#1e3a8a] leading-relaxed">
                Faça login para garantir a confiabilidade das informações registradas.
              </p>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#f59e0b] hover:bg-[#d97706] text-white font-semibold py-4 rounded-xl shadow-md transition-all duration-200 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full border-2 border-[#e5e7eb] hover:border-[#2563eb] text-[#6b7280] hover:text-[#2563eb] font-semibold py-4 rounded-xl transition-all duration-200 active:scale-95 disabled:opacity-60"
            >
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-6">
                <div className="bg-white rounded-2xl shadow-xl p-6 max-w-sm w-full">
                  ...
                  <p className="text-sm text-[#6b7280] text-center leading-relaxed mb-6">
                    Você poderá <strong>visualizar as ocorrências</strong> no mapa, mas para{" "}
                    <strong>registrar uma nova ocorrência</strong> será necessário criar uma conta.
                  </p>
